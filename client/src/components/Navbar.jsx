    ...
    <>
      ...
      <div className="fixed right-4 top-1/2 transform -translate-y-1/2 z-50 flex flex-col space-y-3">
        ...
        >
          ...
          {/* Tooltip */}
          <div className="absolute right-full top-1/2 transform -translate-y-1/2 mr-3 bg-gray-900/90 dark:bg-gray-700/90 text-white group-hover:text-blue-400 text-xs py-2 px-3 rounded-lg opacity-0 group-hover:opacity-100 transition-all duration-200 whitespace-nowrap backdrop-blur-sm border border-gray-600/30">
            About Page
